...
class PerenualClient:
    ...
    async def fetch_info(self, plant_name: str) -> pd.DataFrame:
        ...
        api_url = f"https://perenual.com/api/species-care-guide-list?key={Config.PERENUAL_API_KEY}&q={plant_name}"
        safe_url = api_url.replace(Config.PERENUAL_API_KEY or "", "<api-key>")
